...
const uploadVideo = async (req, res)=>{
    ...
    try {
        ...
        if (!fields.movieId || !Array.isArray(fields.movieId) || fields.movieId.length === 0) {
        ...
        let videoResult;
        try {
            videoResult = await __TURBOPACK__imported__module__$5b$externals$5d2f$cloudinary__$5b$external$5d$__$28$cloudinary$2c$__cjs$29$__["default"].v2.uploader.upload(videoFile.filepath, {
                resource_type: "video",
                folder: "videos"
            });
        ...
        if (imageFile) {
            try {
                const imageResult = await __TURBOPACK__imported__module__$5b$externals$5d2f$cloudinary__$5b$external$5d$__$28$cloudinary$2c$__cjs$29$__["default"].v2.uploader.upload(imageFile.filepath, {
                    resource_type: "image",
                    folder: "thumbnails"
                });
        ...
        const videoDoc = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Video$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["Video"]({
            movieId,
        ...
        if (imageUrl) {
            const imageDoc = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Image$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["Image"]({
                movieId,
                imageUrl
            });
            await imageDoc.save();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5241a6._.js.map