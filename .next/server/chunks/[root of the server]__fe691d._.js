...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Video$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/models/Video.ts [api] (ecmascript)"); // Import the Video model
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Movie$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/models/Movie.ts [api] (ecmascript)"); // Import the Movie model
...
const uploadVideo = async (req, res)=>{
    ...
    form.parse(req, async (err, fields, files)=>{
        ...
        const imageFile = files.image?.[0]; // Assuming there's an image upload
        if (!videoFile) {
        ...
        try {
            ...
            const videoResult = await __TURBOPACK__imported__module__$5b$externals$5d2f$cloudinary__$5b$external$5d$__$28$cloudinary$2c$__cjs$29$__["default"].v2.uploader.upload(videoFile.filepath, {
                resource_type: "video"
            });
            // Optionally, upload image to Cloudinary (if available)
            // let imageUrl = null;
            // if (imageFile) {
            ...
            // }
            // Create the movie document (if not already created)
            const movieId = fields.movieId;
            let movie = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Movie$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["Movie"].findById(movieId);
            if (!movie) {
                return res.status(400).json({
            ...
            await video.save();
            // Create the Image document if an image was uploaded
            // if (imageUrl) {
            ...
            //   await image.save();
            // }
            // Return the response with video and image URLs
            res.status(200).json({
                videoUrl: videoResult.secure_url
            });
        } catch (uploadError) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fe691d._.js.map