...
async function handler(req, res) {
    ...
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prismadb$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                email
            }
        });
        ...
        const hashedPassword = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].hash(password, 12);
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prismadb$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].user.create({
            data: {
                email,
                name,
                hashedPassword,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$register$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/pages/api/register.ts [api] (ecmascript)");
;
;
;
;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1b2bd0._.js.map