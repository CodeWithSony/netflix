...
const DeleteMovie = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const fetchMovie = async ()=>{
            if (!id) return;
            try {
                const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get(`/api/movies?id=${id}`);
    ...
    const handleDelete = async (id)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].delete(`/api/movies?id=${id}`);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__cb14cb._.js.map