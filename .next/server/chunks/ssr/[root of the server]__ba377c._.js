...
"[project]/pages/edit/[id].tsx [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Input = ({ label, value, onChange, id, type })=>{
    ...
    const [movie, setMovie] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(null);
    ...
    const [singer, setSinger] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])("");
    const [cast, setCast] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])([]);
    const [releaseDate, setReleaseDate] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])("");
    ...
    const fetchMovie = async (movieId)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get(`/api/movies/${movieId}`);
            if (res.status === 200) {
    ...
    const handleSave = async ()=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].put(`/api/movies/${id}`, updatedMovie);
            router.push("/"); // Redirect back to the home page or wherever you want
        } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ba377c._.js.map